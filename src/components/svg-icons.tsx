...
const Instagram = (props: SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 264.583 264.583">
        <defs>
            <radialGradient
                href="#instagram_icon_a"
                id="instagram_icon_f"
                cx="158.429"
                cy="578.088"
                r="52.352"
            ...
            <radialGradient
                ...
                gradientUnits="userSpaceOnUse"
            />
            <linearGradient id="instagram_icon_d">
                <stop offset="0" stopColor="#575757" />
                <stop offset="1" stopColor="#656565" />
            </linearGradient>
            <linearGradient id="instagram_icon_c">
                <stop offset="0" stopColor="#484848" />
                <stop offset="1" stopColor="#4a4a4a" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="instagram_icon_b">
                <stop offset="0" stopColor="#c4c4c4" />
                <stop offset="1" stopColor="#c4c4c4" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="instagram_icon_a">
                <stop offset="0" stopColor="#c4c4c4" />
                <stop offset=".124" stopColor="#c4c4c4" />
                <stop offset=".567" stopColor="#787878" />
                <stop offset=".694" stopColor="#5c5c5c" />
                <stop offset="1" stopColor="#595959" stopOpacity="0" />
            </linearGradient>
        </defs>
        <path
            fill="url(#instagram_icon_e)"
        ...
        />
        <path
            fill="url(#instagram_icon_f)"
            d="M204.15 18.143c-55.23 0-71.383.057-74.523.317-11.334.943-18.387 2.728-26.07 6.554-5.922 2.942-10.592 6.351-15.201 11.13-8.394 8.716-13.481 19.439-15.323 32.184-.895 6.188-1.156 7.45-1.209 39.056-.02 10.536 0 24.4 0 42.999 0 55.2.062 71.341.326 74.476.916 11.032 2.645 17.973 6.308 25.565 7 14.533 20.37 25.443 36.12 29.514 5.453 1.404 11.476 2.178 19.208 2.544 3.277.142 36.669.244 70.081.244 33.413 0 66.826-.04 70.02-.203 8.954-.422 14.153-1.12 19.901-2.606 15.852-4.09 28.977-14.838 36.12-29.575 3.591-7.409 5.412-14.614 6.236-25.07.18-2.28.255-38.626.255-74.924 0-36.304-.082-72.583-.26-74.863-.835-10.625-2.656-17.77-6.364-25.32-3.042-6.182-6.42-10.799-11.324-15.519-8.752-8.361-19.455-13.45-32.21-15.29-6.18-.894-7.41-1.158-39.033-1.213z"
            transform="translate(-71.816 -18.143)"
        />
        <path
            fill="url(#instagram_icon_g)"
            d="M204.15 18.143c-55.23 0-71.383.057-74.523.317-11.334.943-18.387 2.728-26.07 6.554-5.922 2.942-10.592 6.351-15.201 11.13-8.394 8.716-13.481 19.439-15.323 32.184-.895 6.188-1.156 7.45-1.209 39.056-.02 10.536 0 24.4 0 42.999 0 55.2.062 71.341.326 74.476.916 11.032 2.645 17.973 6.308 25.565 7 14.533 20.37 25.443 36.12 29.514 5.453 1.404 11.476 2.178 19.208 2.544 3.277.142 36.669.244 70.081.244 33.413 0 66.826-.04 70.02-.203 8.954-.422 14.153-1.12 19.901-2.606 15.852-4.09 28.977-14.838 36.12-29.575 3.591-7.409 5.412-14.614 6.236-25.07.18-2.28.255-38.626.255-74.924 0-36.304-.082-72.583-.26-74.863-.835-10.625-2.656-17.77-6.364-25.32-3.042-6.182-6.42-10.799-11.324-15.519-8.752-8.361-19.455-13.45-32.21-15.29-6.18-.894-7.41-1.158-39.033-1.213z"
            transform="translate(-71.816 -18.143)"
        />
        <path
            fill="url(#instagram_icon_h)"
            d="M204.15 18.143c-55.23 0-71.383.057-74.523.317-11.334.943-18.387 2.728-26.07 6.554-5.922 2.942-10.592 6.351-15.201 11.13-8.394 8.716-13.481 19.439-15.323 32.184-.895 6.188-1.156 7.45-1.209 39.056-.02 10.536 0 24.4 0 42.999 0 55.2.062 71.341.326 74.476.916 11.032 2.645 17.973 6.308 25.565 7 14.533 20.37 25.443 36.12 29.514 5.453 1.404 11.476 2.178 19.208 2.544 3.277.142 36.669.244 70.081.244 33.413 0 66.826-.04 70.02-.203 8.954-.422 14.153-1.12 19.901-2.606 15.852-4.09 28.977-14.838 36.12-29.575 3.591-7.409 5.412-14.614 6.236-25.07.18-2.28.255-38.626.255-74.924 0-36.304-.082-72.583-.26-74.863-.835-10.625-2.656-17.77-6.364-25.32-3.042-6.182-6.42-10.799-11.324-15.519-8.752-8.361-19.455-13.45-32.21-15.29-6.18-.894-7.41-1.158-39.033-1.213z"
            transform="translate(-71.816 -18.143)"
        />
        <path
...
const Biomejs = (props: SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 64 55.425">
        <path
...
const Polar = (props: SVGProps<SVGSVGElement>) => (
    <svg {...props} fill="none" viewBox="0 0 300 300">
        <g clipPath="url(#polar_clip)">
            <path
                fill="currentColor"
                fillRule="evenodd"
...
const Neon = (props: SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 256 256" preserveAspectRatio="xMidYMid">
        <defs>
            <linearGradient id="neon_a" x1="100%" x2="12.069%" y1="100%" y2="0%">
                <stop offset="0%" stopColor="#62F755" />
                <stop offset="100%" stopColor="#8FF986" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="neon_b" x1="100%" x2="40.603%" y1="100%" y2="76.897%">
...
const Upstash = (props: SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 256 341" preserveAspectRatio="xMidYMid">
        <path
            fill="#00C98D"
